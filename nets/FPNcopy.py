...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None):
        ...
        self.bottleneck = nn.Sequential(
            nn.Conv2d(in_channels=in_planes, out_channels=planes, kernel_size=1, bias=False),
            ...
            nn.BatchNorm2d(num_features=planes),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=planes, out_channels=self.expansion * planes, kernel_size=1, bias=False),
    ...
    def _make_layer(self, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != Bottleneck.expansion * planes:
            downsample = nn.Sequential(
                nn.Conv2d(in_channels=self.inplanes, out_channels=Bottleneck.expansion * planes,
                          kernel_size=1, stride=stride, bias=False),
                nn.BatchNorm2d(num_features=Bottleneck.expansion * planes)
            )
